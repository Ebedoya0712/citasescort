    ...
    <div class="flex items-center justify-between mb-8">
        ...
        <div class="flex items-center gap-4">
            ...
            <div class="flex gap-2">
                <button @click="prev()" class="p-2 rounded-full bg-gray-100 dark:bg-zinc-800 hover:bg-red-600 hover:text-white transition-colors">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"></path></svg>
                </button>
                <button @click="next()" class="p-2 rounded-full bg-gray-100 dark:bg-zinc-800 hover:bg-red-600 hover:text-white transition-colors">
