<section class="relative h-[480px] sm:h-[550px] md:h-[650px] flex items-center justify-center overflow-hidden hero-video">
    ...
    <div class="relative z-20 max-w-7xl mx-auto px-4 lg:px-8 text-white w-full hero-content flex flex-col justify-center h-full pt-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 max-w-6xl mx-auto w-full">
            <!-- Feature 1 -->
            <div class="flex flex-col items-center md:items-start p-6 bg-black/45 backdrop-blur-md rounded-2xl border border-white/5 hover:border-red-600/30 hover:bg-black/60 transition-all duration-300 group hover:-translate-y-1 hover:shadow-xl hover:shadow-red-600/5">
                <div class="mb-4 p-3 bg-red-600/10 rounded-2xl border border-red-600/20 text-red-600 group-hover:scale-110 transition-transform duration-300">
