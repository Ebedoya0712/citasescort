<section class="max-w-7xl mx-auto px-4 lg:px-8 py-12 border-t border-zinc-900">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 max-w-6xl mx-auto w-full">
        <!-- Feature 1 -->
        <div class="flex flex-col items-center md:items-start p-6 bg-zinc-900 rounded-2xl border border-zinc-800 hover:border-red-600/30 hover:bg-zinc-800 transition-all duration-300 group hover:-translate-y-1 hover:shadow-xl hover:shadow-red-600/5">
